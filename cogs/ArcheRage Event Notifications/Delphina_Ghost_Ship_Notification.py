...
class DelphinadGhostShip(commands.Cog):
    def __init__(self, client):
        ...
        notification_times = [
            "05 20 * * mon",  # 8:05 PM on Monday
            "05 20 * * tue",  # 8:05 PM on Tuesday
            "05 20 * * wed",  # 8:05 PM on Wednesday
        ]
    ...
    async def on_ready(self):
        print("Delphinad_Ghost_Ship_Notification")
...
async def setup(client):
    await client.add_cog(DelphinadGhostShip(client))
