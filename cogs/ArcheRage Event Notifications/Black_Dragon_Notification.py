...
class BlackDragon(commands.Cog):
    def __init__(self, client):
        ...
        notification_times = [
            "50 19 * * tue",  # 7:50 PM on Tuesday
            "50 16 * * sat",  # 4:50 PM on Saturday
            "50 8 * * sun",  # 8:50 AM on Sunday
        ]
    ...
    async def on_ready(self):
        print("Black_Dragon_Notification")
...
async def setup(client):
    await client.add_cog(BlackDragon(client))
